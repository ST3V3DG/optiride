...
const formSchema = z
  .object({
    ...
    cni_passport_number: z.string(),
    phone: z.string().min(9),
    // profile_picture: z.file().max(1_000_000),
  })
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-2">
                  ...
                  <div className="grid gap-3">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel htmlFor="cni_passport_number">
                            CNI/Password
                          </FormLabel>
                          <FormControl>
                            <Input
                              id="cni_passport_number"
                              type="text"
                              placeholder="Enter your CNI/Passport number"
                              {...field}
                            />
                          </FormControl>
                          <FormMessage />
                  ...
                  {/* <div className="grid gap-3 lg:col-span-2 mt-2">
                    <FormField
                      control={form.control}
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl className="placeholder:text-black">
                            <Input
                              id="profile_picture"
                              type="file"
